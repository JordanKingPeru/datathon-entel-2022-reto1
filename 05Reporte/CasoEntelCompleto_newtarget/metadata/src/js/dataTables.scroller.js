...
$.extend( Scroller.prototype, {
	...
	*/
	...
	"_fnConstruct": function ()
	{
		...
		//GRMlab
		this.dom.scroller.setAttribute('tabindex','1');
		this.dom.scroller.style.outline = "none";
...
//GRMlabconsole.log('DTrowHeight:'+this.s.heights.row);
		container.remove();
	},
	...
	"_fnInfo": function ()
	{
		// GRMlab: Evitar update en cabecera con el scroll
		return;
		if ( !this.s.dt.oFeatures.bInfo )
		{
			return;
